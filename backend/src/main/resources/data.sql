...
(1, 1, 2, '세로 영상과 이미지가 섞인 피드입니다.\n세로 영상과 이미지가 섞인 피드입니다.세로 영상과 이미지가 섞인 피드입니다.세로 영상과 이미지가 섞인 피드입니다.', NOW(), NOW()),
...
(7, 1, 2, '이미지, 가로 영상, 음성이 모두 섞인 종합 선물 세트.세로 영상과 이미지가 섞인 피드입니다.세로 영상과 이미지가 섞인 피드입니다.세로 영상과 이미지가 섞인 피드입니다.', NOW(), NOW()),
(8, 1, 3, '축하드립니다! 대박나세요.', NOW(), NOW()),
(9, 1, 1, '세로 영상과 음성의 조합.', NOW(), NOW()),
(10, 1, 2, '가로 영상과 이미지가 교차로 등장합니다.', NOW(), NOW()),
(11, 1, 3, '이미지 2개와 음성 1개 조합.', NOW(), NOW()),
(12, 1, 1, '가로 영상 5개 대량 업로드 테스트.세로 영상과 이미지가 섞인 피드입니다.세로 영상과 이미지가 섞인 피드입니다.세로 영상과 이미지가 섞인 피드입니다.', NOW(), NOW()),

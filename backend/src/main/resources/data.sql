...
(1, 1, '2026 부스트캠프 송별회', '최동현', 'https://picsum.photos/800/400?random=1,https://picsum.photos/800/400?random=2', '2026-02-04', '18:00:00', '23:00:00', '강남역 어느 카페', '서울특별시 강남구 테헤란로', 37.4979, 127.0276, '강남역 10번 출구에서 직진하세요!', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 6, '2026년 안드라이프 송년 파티', '안드라이프', 'https://picsum.photos/800/600?random=3', '2026-12-31', '13:30:00', NULL, '코드스쿼드', '서울특별시 강남구 강남대로62길 23, 4층 역삼빌딩', 37.4936874, 127.0302304, '양재역 3번 출구에서 801m', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- [PAST] 이미 지난 모임들
(3, 2, '미오의 자취방 집들이', '집주인 미오', 'https://picsum.photos/400/400?random=10,https://picsum.photos/400/400?random=11', '2026-02-06', '14:00:00', '20:00:00', '우리집', '서울 관악구 관악로 1', 37.478, 126.952, '서울대입구역 2번 출구로 나와서 5분만 걸어오세요!', '2025-11-01 10:00:00', NOW()),
...
(5, 6, '안드라이프 25년 연말 회식', '안드라이프', 'https://picsum.photos/400/400?random=13,https://picsum.photos/400/400?random=14', '2025-12-28', '18:30:00', '23:59:00', '교대역 맛집', '서울 서초구 서초대로 314', 37.493, 127.014, '예약석 명단 확인 부탁드립니다.', '2025-12-10 10:00:00', NOW()),
-- [UPCOMING] 곧 다가올 모임들
...
-- [ID 11~12] 초대장 2번
(11, 2, 2, '안드라이프 신년회 기대됩니다! 장소도 좋네요.', NOW(), NOW()),
(12, 2, 3, '맛있는 거 많이 준비해 주세요 ㅎㅎ', NOW(), NOW()),
-- [ID 13~14] 초대장 3번
(13, 3, 1, '집들이 음식 너무 맛있었어요! 특히 파스타 대박.', '2026-01-25 21:00:00', NOW()),
(14, 3, 4, '집이 너무 예뻐요. 미오님 감각 최고!', '2026-01-26 10:00:00', NOW()),
-- [ID 15~16] 초대장 7번
(15, 7, 1, '클라이밍 처음인데 잘 가르쳐주세요!', NOW(), NOW()),
(16, 7, 4, '전용 신발 빌릴 수 있나요?', NOW(), NOW()),
-- [ID 17] 초대장 8번
(17, 8, 3, '분위기 좋은 와인바네요! 기대 중입니다.', NOW(), NOW()),
-- [ID 18~19] 초대장 9번
(18, 9, 1, '카메라 풀충전해서 가겠습니다!', NOW(), NOW()),
(19, 9, 5, '도시락 싸가야 할까요?', NOW(), NOW()),
-- [ID 20~21] 초대장 10번
(20, 10, 3, '테니스 라켓 빌려주실 분 계신가요?', NOW(), NOW()),
(21, 10, 4, '아침 테니스 상쾌하겠네요. 참여합니다!', NOW(), NOW());
...
(11, 'https://picsum.photos/400/600?random=20', 0),
(13, 'https://picsum.photos/400/600?random=21', 0),
(13, 'https://picsum.photos/400/600?random=22', 1),
(14, 'https://picsum.photos/400/600?random=23', 0),
(18, 'https://picsum.photos/400/600?random=24', 0),
(21, 'https://picsum.photos/400/600?random=25', 0);
...
(12, 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', 20, 0),
(15, 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', 10, 0);
...
(2, 19, 'https://www.w3schools.com/html/movie.mp4', 'https://picsum.photos/400/600?random=30', 15, 0);
...
(2, 'https://picsum.photos/200/300?random=32', 7.5);
